...
export default function FAQSection() {
  return (
    <section id="faq" className="border-b border-neutral-200 bg-neutral-50 py-16 sm:py-24 dark:border-neutral-800 dark:bg-neutral-900/50">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-xl border border-neutral-200 bg-white p-4 sm:p-6 md:p-8 dark:border-neutral-800 dark:bg-neutral-950">
          <Accordion type="single" collapsible className="w-full">
            {faqsData.map((faq) => (
              <AccordionItem key={faq.id} value={faq.id}>
                <AccordionTrigger className="text-left text-sm sm:text-base font-bold text-neutral-950 dark:text-neutral-50 hover:no-underline">
                  {faq.question}
                </AccordionTrigger>
