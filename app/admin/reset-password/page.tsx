        ...
        <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-6 sm:p-8 shadow-2xl space-y-6 backdrop-blur">
          {success ? (
            <div className="space-y-4 text-center">
              ...
              <h3 className="text-lg font-bold font-sans text-white">Password Reset Complete</h3>
            ...
            <form onSubmit={handleReset} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="new-password" className="text-xs font-mono uppercase tracking-wider text-neutral-300">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="confirm-password" className="text-xs font-mono uppercase tracking-wider text-neutral-300">
