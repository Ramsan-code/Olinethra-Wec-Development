...
export default function TechnologiesSection() {
  return (
    <section id="technologies" className="border-b border-neutral-200 bg-neutral-50 py-24 dark:border-neutral-800 dark:bg-neutral-900/50">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {techCat.items.map((item) => {
                  ...
                  return (
                    <div
                      key={item.name}
                      className="group flex items-start gap-4 rounded-xl border border-neutral-200 bg-white p-4 transition-all duration-200 hover:border-neutral-400 hover:shadow-xs dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-neutral-700"
                    >
